...
<head>
    ...
    <script type="text/javascript">
        ...
        function fncMrReserve() {
            ...
            form.action = "<c:url value='insertReserve'/>";
            form.submit();
        }
...
<body>
    <div class="container mt-5">
        <form:form modelAttribute="mrReserveVO" name="mtgPlaceResve" id="mtgPlaceResve" method="post">
            ...
            <div class="wTableFrm">
                <!-- 타이틀 -->
                <h2 class="mb-4">회의실 예약신청</h2>
                <!-- 등록폼 -->
                <table class="table table-bordered">
                    <tr>
                        <th>제목 <span class="text-danger"></span></th>
                        <td colspan="3">
                            <input name="title" type="text" class="form-control" maxlength="70" title="제목" required="required" />
                        </td>
                    </tr>
                    <tr>
                        <th>회의실명 <span class="text-danger"></span></th><!-- 회의실명 -->
                        <td colspan="3">
                            <c:out value="${mtRoomVO.mr_Name}" />
                        </td>
                    </tr>
                    <tr>
                        <th>회의실 위치 <span class="text-danger"></span></th><!-- 회의실 위치 -->
                        <td colspan="3">
                            <c:out value="${mtRoomVO.location}" /> <c:out value="${mtRoomVO.building}" /> <c:out value="${mtRoomVO.roomNo}" />
                        </td>
                    </tr>
                    <tr>
                        <th>예약자 ID <span class="text-danger"></span></th><!-- 예약자 -->
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input name="attendees" type="text" class="form-control" value="<c:out value='${mtgPlaceManageVO.atndncNmpr}'/>" maxlength="3"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <form:textarea path="contents" class="form-control" rows="4" cols="70" title="회의내용" required="required"></form:textarea>
                        </td>
                    </tr>
                    <!-- 첨부파일 테이블 레이아웃 설정 Start.. -->
                    <c:if test="${!empty mtRoomVO.picture}">
                        <tr>
                            <th class="required_text">이미지 파일</th><!-- 이미지 파일목록 -->
                            <td colspan="3">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <button type="button" class="btn btn-primary me-2" onclick="fncMrReserve();">저장</button>
                    <a href="<c:url value='/mtRoomList'/>?searchCondition=1" class="btn btn-secondary">목록</a>
                </div>
